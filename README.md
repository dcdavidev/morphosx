...
_Stores the file in the `originals/` folder. Returns a public `asset_id` accessible by anyone with a signed URL._
...
_Stores the file in `users/{user_id}/`. Access is restricted to the owner._
